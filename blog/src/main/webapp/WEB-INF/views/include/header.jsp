        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <c:choose>
	            <c:when test="${not empty sessionScope.user_id }">
	              	...
	              	<a href="/user/logout"><i class="fa fa-circle text-red"></i> 로그아웃</a>
	            </c:when>
	            <c:otherwise>
	            	<a href="/user/login"><i class="fa fa-circle text-yellow"></i> 로그인</a>
	            </c:otherwise>
            </c:choose>
            </div>
          </div>
          ...
          <ul class="sidebar-menu">
            <li class="header">LABELS</li>
                        <c:choose>
	            <c:when test="${not empty sessionScope.user_id }">
		            <li><a href="/user/logout"><i class="fa fa-circle-o text-red"></i> <span>로그아웃</span></a></li>
<!-- 		            <li><a href="/user/myPage"><i class="fa fa-circle-o text-green"></i> <span>마이페이지</span></a></li> -->
	            </c:when>
	            <c:otherwise>
		            <li><a href="/user/login"><i class="fa fa-circle-o text-yellow"></i> <span>로그인</span></a></li>
		            <li><a href="/user/join"><i class="fa fa-circle-o text-aqua"></i> <span>회원가입</span></a></li>
	            </c:otherwise>
            </c:choose>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-folder"></i> <span>util</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="/util/address"><i class="fa fa-circle-o"></i> 주소로 위치 보기</a></li>
                <li><a href="/util/weather"><i class="fa fa-circle-o"></i> 날씨</a></li>
              </ul>
            </li>
<!--             <li class="treeview"> -->
<!--               <a href="#"> -->
<!--                 <i class="fa fa-envelope"></i> <span>메시지</span> -->
<!--                 <i class="fa fa-angle-left pull-right"></i> -->
<!--               </a> -->
<!--               <ul class="treeview-menu"> -->
<!--                 <li><a href="#"><i class="fa fa-circle-o"></i>메시지 목록</a></li> -->
<!--                 <li><a href="#"><i class="fa fa-circle-o"></i>메시지 보내기</a></li> -->
<!--               </ul> -->
<!--             </li> -->
